...
namespace StardewClaudeCompanion
{
    public class ModEntry : Mod
    {
        ...
        private FullShipmentCollectionService fullShipmentService = null!;
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            this.fullShipmentService = new FullShipmentCollectionService(this.Helper);
